            ...
            <div className="order-1 lg:order-2 relative">
              ...
              >
                <img
                  ...
                  onError={(e) => e.target.src = 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=1600&q=80'}
                />
              </motion.div>
              {/* Floating Card */}
                    ...
                    {imageOptions.map((img, index) => (
                      ...
                      >
                        <img
                          ...
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.target.src = 'https://placehold.co/200x100/e2e8f0/64748b?text=Image';
                          }}
                        />
                        {selectedImage === img && (
