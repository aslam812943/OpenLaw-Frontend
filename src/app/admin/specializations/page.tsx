...
const SpecializationsPage = () => {
    ...
    const columns: Column<Specialization>[] = [
        { header: 'Name', accessor: 'name', className: 'font-medium text-slate-200' },
        { header: 'Description', accessor: 'description', className: 'text-slate-400' },
        {
            header: 'Status',
            render: (row) => (
                <span className={`px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${row.isActive ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20' : 'bg-red-500/10 text-red-500 border border-red-500/20'}`}>
        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded-xl hover:bg-emerald-700 transition-all shadow-lg active:scale-95"
                >
                    <Plus size={20} />
                    Add New
                </button>
