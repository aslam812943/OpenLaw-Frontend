...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-green-50 p-4 overflow-hidden relative">
      {/* Background icons for consistent model look */}
        ...
        >
          ...
          <div className="mb-5">
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-400 bg-white/80 outline-none transition-all duration-300"
            />
          </div>
          <div className="mb-5">
            <label className="block text-sm font-semibold text-gray-700 mb-2">
